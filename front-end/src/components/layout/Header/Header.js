            ...
            `}>
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <Link to="/" className="flex items-center gap-1.5 transition-all duration-normal hover:scale-105 group">
                            <div className="transition-all">
                                <img src="/logo.PNG" alt="AXIONET" className="h-10 w-auto" />
                            </div>
                            <span className="text-xl font-black tracking-tighter bg-gradient-to-r from-primary via-purple-500 to-blue-400 bg-clip-text text-transparent italic">
                                AXIONET
                            </span>
                        </Link>
                    </div>
